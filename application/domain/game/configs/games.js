() => {
  ...
  return {
    master: {
      ...baseConfig,
      ...{ title: 'С ведущим', icon: ['fa', 'desktop'] },
      itemsDefault: { ...baseConfig.itemsDefault, gameMaster: true },
    },
    trainer: { ...baseConfig, title: 'Тренажер', icon: ['fa', 'desktop'] },
  };
};
